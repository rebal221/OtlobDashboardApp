...
import '../pages/auth/auth_page/binding/auth_page_binding.dart';

class MyBodyRestaurant extends StatefulWidget {
  int selectedIndex = 0;
  Widget myBody;
  ...
  @override
  State<MyBodyRestaurant> createState() => MyBodyRestaurantState();
}

class MyBodyRestaurantState extends State<MyBodyRestaurant> {
  ...
  void initState() {
    ...
    MainRestaurantPage.selectedIndex = selectedIndex;
    super.initState();
  }
